      ...
      <main className="pt-20 p-5 text-justify text-gray-900 grid bg-gradient-to-b from-blue-100 to-blue-50" id="terms">
        <div className="place-self-center max-w-5xl">
            ...
            <ul>
                ...
                <li>
                    <p><span>Website</span> refers to Raul Carini, accessible from <Link href="https://www.raulcarini.com" className="text-blue-600">www.raulcarini.com</Link></p>
                </li>
                <li>
            ...
            <h3 className="text-xl font-bold text-blue-800 mb-1">Tracking Technologies and Cookies</h3>
