...
export default function Privacy() {
    return (
        <>
      <Head>
        <title>Privacy Policy - Raul Carini</title>
        <meta name="description" content="Privacy Policy of Raul Carini"/>
      ...
      <main className="p-10 text-justify text-gray-900 grid" id="terms">
        <div className="place-self-center max-w-5xl">
            ...
            <ul>
                ...
                <li>
                    <p><span>Company</span> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Raul Carini.</p>
                </li>
                <li>
                ...
                <li>
                    <p><span>Country</span> refers to: Italy</p>
                </li>
                <li>
                ...
                <li>
                    <p><span>Website</span> refers to Raul Carini, accessible from <Link href="/" className="text-blue-600">https://www.raulcarini.com</Link></p>
                </li>
                <li>
            ...
            <h1 className="text-3xl font-bold text-blue-600">Collecting and Using Your Personal Data</h1>
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Types of Data Collected</h2>
            <h3 className="text-xl font-bold text-blue-800 mb-1">Personal Data</h3>
            <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
            <ul>
                <li>Usage Data</li>
            </ul>
            <h3 className="text-xl font-bold text-blue-800 mb-1">Usage Data</h3>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Use of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Retention of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Transfer of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Delete Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Disclosure of Your Personal Data</h2>
            <h3 className="text-xl font-bold text-blue-800 mb-1">Business Transactions</h3>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h3 className="text-xl font-bold text-blue-800 mb-1">Law enforcement</h3>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h3 className="text-xl font-bold text-blue-800 mb-1">Other legal requirements</h3>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mb-1">Security of Your Personal Data</h2>
            <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            <h1 className="text-3xl font-bold text-blue-600">Children's Privacy</h1>
            ...
            <h1 className="text-3xl font-bold text-blue-600">Links to Other Websites</h1>
            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We spanly advise You to review the Privacy Policy of every site You visit.</p>
            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
            <h1 className="text-3xl font-bold text-blue-600">Changes to this Privacy Policy</h1>
            ...
            <ul>
                <li>By visiting this page on our website: <Link href="/#contacts" className="text-blue-600">https://raulcarini.com/#contact</Link></li>
            </ul>
        </div>
      </main>
      <Footer/>
