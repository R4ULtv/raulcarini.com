...
export default function Contacts() {
    return(
        <div className="pt-20 p-10 animate-fadeIn " id="contacts">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 max-w-7xl mx-auto my-8">
                <a className="relative p-4 border rounded-xl flex flex-col items-center gap-4 border-blue-500" href="https://twitter.com/R4ULtv" target="_blank">
                    <span className="absolute w-px h-2/3 bg-gradient-to-b from-blue-500 via-blue-500/50 to-transparent" aria-hidden="true"></span>
                ...
                <a className="relative p-4 border rounded-xl flex flex-col items-center gap-4 border-blue-500" href="mailto:dev@raulcarini.com" target="_blank">
                    <span className="absolute w-px h-2/3 bg-gradient-to-b from-blue-500 via-blue-500/50 to-transparent" aria-hidden="true"></span>
                    <div className='relative border rounded-full p-2 bg-white border-blue-500'>
                ...
                <a className="relative p-4 border rounded-xl flex flex-col items-center gap-4 border-blue-500" href="https://github.com/R4ULtv" target="_blank">
                    <span className="absolute w-px h-2/3 bg-gradient-to-b from-blue-500 via-blue-500/50 to-transparent" aria-hidden="true"></span>
                    <div className='relative border rounded-full p-2 bg-white border-blue-500'>
